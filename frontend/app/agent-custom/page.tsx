...
const CustomPage = () => {
    ...
    const initWatsonX = () => {
      try {
        window.wxOConfiguration = {
          ...
          layout: {
            form: 'custom', // Options: float | custom | fullscreen-overlay - if not specified float is default
            customElement: hostRef.current
          }
        }
  ...
  return (
    <div className="space-y-4 p-6">
      ...
      <div className="card min-h-screen border">test</div>
    </div>
  )
}
